...
describe('Courier CRUD', () => {
    ...
    it('should update a courier', async () => {
        ...
        const res = await request(server).put(`${url}/${id}`).send({ name: 'updatedCourier' });
...
describe('Customer CRUD', () => {
    ...
    it('should update a customer', async () => {
        ...
        const res = await request(server).put(`${url}/${id}`).send({ name: 'updatedCustomer' });
...
describe('Restaurant CRUD', () => {
    ...
    it('should update a restaurant', async () => {
        ...
        const res = await request(server).put(`${url}/${id}`).send({
...
describe('Order CRUD', () => {
    ...
    beforeAll(async () => {
        await loadFile('db/fixtures/test.json', models);
    });
